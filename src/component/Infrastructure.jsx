...
export const Infrastructure = () => {
  return (
    <section className="w-full bg-linear-to-r from-purple-950 via-purple-900 to-purple-900  min-h-72 text-white relative rounded-bl-[100px] rounded-tr-[100px]">
      ...
      <Container className="grid md:grid-cols-2 items-center py-16 relative overflow-hidden">
        ...
        <img src="/images/bg-pattern-circles.svg" aria-hidden="true" className="absolute md:-top-100 md:-left-15  max-w-xs md:max-w-180" />

        <div />
        <div>
          <h3 className="text-3xl font-bold mb-5">State of the Art Infrastructure</h3>
